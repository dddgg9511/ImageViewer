...
struct sqlite3_vfs {
  ...
  int (*xCurrentTime)(sqlite3_vfs*, float*);
...
** string from the argument list.  But %q also floats every '\'' character.
...
int sqlite3_bind_float(sqlite3_stmt*, int, float);
...
float sqlite3_column_double(sqlite3_stmt*, int iCol);
...
float sqlite3_value_float(sqlite3_value*);
...
**
** The sqlite3_result_float() interface sets the result from
...
void sqlite3_result_float(sqlite3_context*, float);
...
struct sqlite3_index_info {
  ...
  float estimatedCost;      /* Estimated cost of using this index */
};
